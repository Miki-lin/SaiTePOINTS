...
if __name__ == '__main__':
    path1 = "../data/haizhu_1134/label_2"  # 确定文件夹路径
    allfile1 = readFilename(path1)
    imagesets = '../data/haizhu_1134/ImageSets'
    ...
    WriteDatasToFile(allfile1[:l_train], txt_train)
    WriteDatasToFile(allfile1[l_train:], txt_val)
